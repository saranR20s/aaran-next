    ...
    <x-Ui::forms.m-panel>
        ...
        <x-Ui::table.form>
            <x-slot:table_header>
                ...
                <x-Ui::table.header-text > Vehicle No</x-Ui::table.header-text>
            ...
            <x-slot:table_body>
                @foreach($list as $index=>$row)
                    <x-Ui::table.row>
                        ...
                        <x-Ui::table.cell-text >{{$row->vehicle_no}}</x-Ui::table.cell-text>
        ...
        <x-Ui::forms.create :id="$vid" >
            <x-Ui::input.floating wire:model="vname" label="Transport" style="margin-bottom: 1rem" />
